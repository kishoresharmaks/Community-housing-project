    ...
    <div className="apartment-right-main-sec">
      ...
      <div className="complaints-filter">
        {["All", "Block - A", "Block - B"].map((filter) => (
          <button
            key={filter}
            className={`c-block-button ${activeFilter === filter ? "active" : ""}`}
          ...
          <table>
            ...
            <tbody>
              {filteredParkingData.map((data, index) => (
                <tr key={index}>
                  <td className="parking-lot-number">{index + 1}</td>
                  <td className="parking-lot-number">{data.parkingNo}</td>
                  <td className="parking-lot-number">{data.flatNo}</td>
                </tr>
              ))}
            </tbody>
          </table>
